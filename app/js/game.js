...
var selectedCountry = { "name": "Morocco", "colors": ["#c1272d", "#006233"], "geo": { "latitude": 31.791702, "longitude": -7.09262 }, "data": { "cases": 275586, "deaths": 20 } }
...
var Pilot = function() {
    ...
    var bodyMat = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var faceMat = new THREE.MeshLambertMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)] });
    var face = new THREE.Mesh(faceGeom, faceMat);
    this.mesh.add(face);

    var hairGeom = new THREE.BoxGeometry(4, 4, 4);
    var hairMat = new THREE.MeshLambertMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)] });
    ...
    var glassMat = new THREE.MeshLambertMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)] });
...
var AirPlane = function() {
    ...
    var matCabin = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var matEngine = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var matTailPlane = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var matSideWing = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var matWindshield = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], transparent: true, opacity: .3, shading: THREE.FlatShading });;
    ...
    var matPropeller = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var matBlade = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var wheelProtecMat = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    var wheelProtecR = new THREE.Mesh(wheelProtecGeom, wheelProtecMat);
    wheelProtecR.position.set(25, -20, 25);
    this.mesh.add(wheelProtecR);

    var wheelTireGeom = new THREE.BoxGeometry(24, 24, 4);
    var wheelTireMat = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    var wheelTireR = new THREE.Mesh(wheelTireGeom, wheelTireMat);
    wheelTireR.position.set(25, -28, 25);

    var wheelAxisGeom = new THREE.BoxGeometry(10, 10, 6);
    var wheelAxisMat = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
    ...
    var suspensionMat = new THREE.MeshPhongMaterial({ color: selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], shading: THREE.FlatShading });
...
SeaEnemy = function() {
    ...
    this.mesh = new THREE.Mesh(geom, mat);
    this.mesh.castShadow = true;
    this.mesh.scale.set(1.8, 1.8, 1.3)
    this.angle = 0;
    this.dist = 0;
}
...
SeaObjectsHolder.prototype.spawnSeaEnemies = function() {
    ...
    for (var i = 0; i < nSeaEnemies; i++) {
        ...
        enemy.mesh.position.x = airplane.mesh.position.x + Math.random() * 70;
...
SeaObjectsHolder.prototype.increaseSeaEnemies = function() {
    ...
    enemy.distance = game.seaRadius + game.planeDefaultHeight + (-1 + Math.random() * 2) * (game.planeAmpHeight - 20);
    enemy.mesh.position.y = 10;
    enemy.mesh.position.x = airplane.mesh.position.x + Math.random() * 50;
    this.mesh.add(enemy.mesh);
    this.seaEnemiesInUse.push(enemy);
...
EnemiesHolder.prototype.spawnEnemies = function() {
    ...
    for (var i = 0; i < nEnemies; i++) {
        ...
        console.log('spawned enemy: ', enemy.mesh.position)
...
SeaObjectsHolder.prototype.rotateEnemies = function() {
    for (var i = 0; i < this.seaEnemiesInUse.length; i++) {
        ...
        enemy.mesh.translateY(game.enemiesSpeed * deltaTime)
            //enemy.mesh.position.x = Math.cos(enemy.angle)*enemy.distance;
        ...
        if (d < game.enemyDistanceTolerance) {
            particlesHolder.spawnParticles(enemy.mesh.position.clone(), 15, selectedCountry.colors[Math.round(Math.random() * selectedCountry.colors.length - 1)], 3);
...
EnemiesHolder.prototype.rotateEnemies = function() {
    for (var i = 0; i < this.enemiesInUse.length; i++) {
        ...
        if (d < game.enemyDistanceTolerance) {
            ...
            this.mesh.remove(enemy.mesh);
            particlesHolder.spawnParticles(enemy.mesh.position.clone(), 5, 0x009999, .8);
            game.planeCollisionSpeedX = 100 * diffPos.x / d;
            game.planeCollisionSpeedY = 100 * diffPos.y / d;
